...
public class TestDocument {
    ...
    public final void test_get_input_filetype_RAW() {
        ...
        DocumentLoadType actual = doc_api.get_doc_type();
    ...
    public final void test_get_line_blocks_RAW() {
        this.doc_api = get_raw_api();
        List<LineBlock> actual = this.doc_api.get_line_blocks();
    ...
    public final void test_line_blocks_have_at_least_one_element() {
        this.doc_api = get_raw_api();
        int expected = this.doc_api.get_line_blocks().size();
        int actual = 0;
    ...
    public final void test_line_blocks_correct_size() {
        this.doc_api = get_raw_api();
        int expected = 5;
        int actual = this.doc_api.get_line_blocks().size();
        assertEquals(expected, actual);
    }
    ...
    public final void test_raw_correct_values() {
        this.doc_api = get_raw_api();
        assertEquals(5, doc_api.get_line_blocks().size());

        String actual0 = this.doc_api.get_line_blocks().get(0).get_lines().get(0);
        String expected0 = "TITLE AND STUFF";
        assertEquals(expected0, actual0);

        String actual1 = this.doc_api.get_line_blocks().get(1).get_lines().get(0);
        String expected1 = "paragraph1";
        assertEquals(expected1, actual1);

        String actual11 = this.doc_api.get_line_blocks().get(1).get_lines().get(1);
        String expected11 = "sub1.1";
        assertEquals(expected11, actual11);

        String actual12 = this.doc_api.get_line_blocks().get(1).get_lines().get(2);
        String expected12 = "sub1.2";
        assertEquals(expected12, actual12);

        String actual2 = this.doc_api.get_line_blocks().get(2).get_lines().get(0);
        String expected2 = "paragraph2";
        assertEquals(expected2, actual2);

        String actual21 = this.doc_api.get_line_blocks().get(2).get_lines().get(1);
        String expected21 = "sub2.1";
        assertEquals(expected21, actual21);

        String actual3 = this.doc_api.get_line_blocks().get(3).get_lines().get(0);
        String expected3 = "paragraph3";
        assertEquals(expected3, actual3);

        String actual4 = this.doc_api.get_line_blocks().get(4).get_lines().get(0);
